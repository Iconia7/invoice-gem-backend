...
class ProLicense(models.Model):
    ...
    jwt_token = models.TextField(default='', help_text="The latest signed JWT issued to this device")
    is_active = models.BooleanField(default=True)
    amount_paid = models.IntegerField(default=0, help_text="Amount paid in minor units (e.g. kobo/cents)")
